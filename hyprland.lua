...
hl.config({
	general = {
		...
		col = {
			active_border = { colors = { "rgba(00ccff99)", "rgba(00ccff11)" }, angle = 90 },
...
hl.animation({ leaf = "workspaces", enabled = false, speed = 1.5, bezier = "linear", style = "fade" })
...
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd("hyprshot -m region --freeze -s -o /home/batya/screenshots"))
hl.bind(
	mainMod .. " + M",
...
-- window rules to span them in workspaces
hl.window_rule({
	name = "firefox",
	match = { class = "firefox" },
	workspace = 1,
