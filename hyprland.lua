...
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd("hyprshot -m region --freeze -s -o /home/timur/screenshots"))
hl.bind(
	mainMod .. " + M",
...
hl.bind("CTRL + SPACE", hl.dsp.exec_cmd("/home/timur/.config/rofi/scripts/launcher_t2"))
